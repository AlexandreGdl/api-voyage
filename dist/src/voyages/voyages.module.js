...
const voyages_schema_1 = require("./schema/voyages.schema");
const widgets_schema_1 = require("../widgets/schema/widgets.schema");
...
VoyagesModule = __decorate([
    common_1.Module({
        ...
        exports: [voyages_service_1.VoyagesService],
    })
], VoyagesModule);
